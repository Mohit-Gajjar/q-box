...
class LevelQuestion extends StatefulWidget {
  final String subjectName, chapter;
  const LevelQuestion({Key? key, required this.subjectName, required this.chapter,})
      : super(key: key);

  @override
  State<LevelQuestion> createState() => _LevelQuestionState();
}

class _LevelQuestionState extends State<LevelQuestion> {
  ...
  Future<Map<String, dynamic>> getQuestions() async {
    ...
    if (snapshot.docs.isNotEmpty) {
      ...
      _userQuestions = data['questionsList'] as Map<String, dynamic>;
